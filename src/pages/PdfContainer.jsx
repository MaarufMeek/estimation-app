    ...
    return (
        <div className="container" id="pdf-content" style={{padding: '20px', lineHeight: '1.6', marginTop: '0'}}>
            ...
            <h1 className={`my-0 ${styles.contacts}`}>
                ...
                </i> Contact: 0547034628 / 0508224178 / yakubuabdulai@gmail.com
            </h1>
            ...
            <div className="d-flex align-content-between justify-content-between">
                <div className={`w-50 ${styles.dFont}`}>
                    ...
                    <p className="my-0 fw-light">Contact: <span
                        className="fw-semibold font">{p.customer.contact}</span></p>
                    <p className="my-0 fw-light">Address: <span className="fw-semibold">{p.customer.address}</span>
                    </p>
                </div>
                <div className={`w-50 ${styles.dFont} text-end`}>
                    ...
                    <p className="my-0 fw-light">Site: <span
                        className="fw-semibold">{p.customer.contract.site}</span></p>
                </div>
            </div>
